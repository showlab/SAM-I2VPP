...
from dataset.vos_raw_dataset import VOSRawDataset
from dataset.vos_sampler import VOSSampler
from dataset.vos_segment_loader import JSONSegmentLoader

from utils.data_utils import Frame, Object, VideoDatapoint
    ...
    def _get_datapoint(self, idx):
        ...
        for retry in range(MAX_RETRIES):
            try:
                ...
                break  # Successfully loaded video
