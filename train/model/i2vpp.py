...
from i2vpp.modeling.i2vpp_base_train import I2VPPBase

from i2vpp.modeling.i2vpp_utils import (
    get_1d_sine_pe,
    get_next_point,
    sample_box_points,
...
from i2vpp.utils.misc import concat_points
import sys
import os
...
class I2VPPTrain(I2VPPBase):
    ...
    # overwrite the function in i2vpp_base_train.py
    def track_step(
        self,
        frame_idx,
        is_init_cond_frame,
        ...
        current_out["multistep_pred_multimasks_memory"] = [memory_masks]  # added for i2vpp
    ...
    def _iter_correct_pt_sampling(
        ...
        all_pred_memory_multimasks = [memory_masks]  # added for i2vpp
        all_pred_ious = [ious]
        ...
        for _ in range(self.num_correction_pt_per_frame):
            ...
            all_pred_memory_multimasks.append(high_res_masks.repeat(1, 4, 1, 1))  # [B,4,H,W] added for i2vpp
        ...
        current_out["multistep_pred_multimasks_memory"] = all_pred_memory_multimasks  # added for i2vpp
