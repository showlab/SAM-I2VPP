...
from utils.train_utils import get_machine_local_and_dist_rank, makedir
...
class TensorBoardWriterWrapper:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        NOTE: If using the logger with distributed train:
...
def shutdown_logging():
    """
    After train is done, we ensure to shut down all the logger streams.
    """
